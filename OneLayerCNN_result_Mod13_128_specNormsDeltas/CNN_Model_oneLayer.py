...
def create_model2():
    ...
    model.add(Conv2D(filters=48, kernel_size=(5, 5), strides=(1, 1), padding='valid', input_shape=(128, 128, 2)))
...
#SAVE Model
modelName='model13_'+str(VERSION)+'validate_'+str(VALIDATION_FOLD)+'.h5'
